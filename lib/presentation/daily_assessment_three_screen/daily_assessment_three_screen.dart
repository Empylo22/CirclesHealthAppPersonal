...
class DailyAssessmentThreeScreen
    extends GetWidget<DailyAssessmentThreeController> {
  const DailyAssessmentThreeScreen({Key? key}) : super(key: key);
