...
class DailyAssessmentFiveScreen
    extends GetWidget<DailyAssessmentFiveController> {
  const DailyAssessmentFiveScreen({Key? key}) : super(key: key);
