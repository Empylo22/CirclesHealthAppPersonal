...
/// This class defines the variables used in the [explore_group_activities_page],
/// and is typically used to hold data that is passed between different parts of the application.
class ExploreGroupActivitiesModel {
  Rx<List<UserprofileItemModel>> userprofileItemList = Rx([
    UserprofileItemModel(
        stackImage: ImageConstant.imgRectangle21.obs,
        todayText: "Today".obs,
        dreamsText: "Every step I take, brings me closer to my dreams".obs),
    UserprofileItemModel(
        stackImage: ImageConstant.imgRectangle22.obs,
