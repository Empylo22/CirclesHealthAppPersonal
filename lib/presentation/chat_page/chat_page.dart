...
import '../chat_page/widgets/userprofilelist3_item_widget.dart';
    ...
    return Padding(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller
                .chatModelObj.value.userprofilelist3ItemList.value.length,
            itemBuilder: (context, index) {
              Userprofilelist3ItemModel model = controller
                  .chatModelObj.value.userprofilelist3ItemList.value[index];
              return Userprofilelist3ItemWidget(model, onTapUserProfile: () {
                onTapUserProfile();
              });
            })));
  }
