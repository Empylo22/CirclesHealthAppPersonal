...
import 'package:empylo/presentation/notifications_settings_screen/models/notifications_settings_model.dart';

/// A controller class for the NotificationsSettingsScreen.
///
...
class NotificationsSettingsController extends GetxController {
  Rx<NotificationsSettingsModel> notificationsSettingsModelObj =
      NotificationsSettingsModel().obs;
