...
class CustomTextFormField extends StatelessWidget {
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.titleSmallOnPrimaryContainer,
        prefixIcon: prefix,
        ...
        contentPadding: contentPadding ??
            EdgeInsets.symmetric(vertical: 19.v, horizontal: 12.h),
        ...
        focusedBorder: borderDecoration ??
            OutlineInputBorder(
              ...
              borderSide: BorderSide(
                color: appTheme.gray80001.withOpacity(0.36),
                width: 1,
              ),
            ),
      );
